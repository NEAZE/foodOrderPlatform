...
//            image.transferTo(new File("static/images/"+originalFilename));
        //获取项目classes/static的地址
        String staticPath = ClassUtils.getDefaultClassLoader().getResource("static").getPath();
        // 图片存储目录及图片名称
        String url_path = "images" + File.separator + originalFilename;
        //图片保存路径
        String savePath = staticPath + File.separator +"web/"+url_path;
...
//        String avatar = parent + filename;
        ...
        String username = getUsernameFromSession(session);
        // 将头像写入到数据库中
        userService.changeAvatar(uid, username, "images/"+originalFilename);
        // 返回成功头像路径
        return new JsonResult<String>(OK, "images/"+originalFilename);
    }
}
